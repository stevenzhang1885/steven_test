...
for rca in $rca_list;do
    ...
    echo "fabric-ca-client enroll -d -u https://$rca-admin:$rca-adminpw@${rca[$tls]} --tls.certfiles $tls-root-cert/$tls-ca-cert.pem  --csr.hosts $CSRHOST --mspdir $rca.admin/msp"
